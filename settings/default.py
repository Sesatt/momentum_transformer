...
QUANDL_TICKERS = ['AMT', 'ORCL', 'MSFT', 'TROW', 'HON', 'T', 'AME', 'ADM', 'FRC', 'FISV', 'CF', 'BKNG', 'CE', 'C', 'KO', 'A', 'CDNS', 'ED', 'XRAY', 'FAST', 'DTE', 'DD', 'ETN', 'SIVB', 'XOM', 'MGM', 'WM', 
                  'GD', 'GE', 'LH', 'GM', 'NXPI', 'CHTR', 'AIZ', 'LYB', 'IR', 'TT', 'FLT', 'TRGP', 'IBM', 'KMI', 'HCA', 'HII', 'MPC', 'XYL', 'MA', 'APTV', 'EPAM', 'CZR', 'ENPH', 'PSX', 'META', 'NOW', 'PNR', 
                  'FANG', 'PCG', 'ABBV', 'NCLH', 'ZTS', 'PEP', 'MO', 'COP', 'CDW', 'NWSA', 'NWS', 'AMGN', 'LIN', 'SLB', 'ALLE', 'HLT', 'CVX', 'GOOG', 'PAYC', 'AAPL', 'AMAT', 'ANET', 'CTLT', 'SYF', 'CFG', 'KEYS', 
                  'MRO', 'VMC', 'PYPL', 'TXN', 'EIX', 'MTCH', 'HSY', 'KR', 'CVS', 'GIS', 'FOX', 'WRB', 'KMB', 'RTX', 'PG', 'CTRA', 'MRNA', 'SO', 'FOXA', 'DOW', 'CAT', 'AMCR', 'CL', 'ROK', 'FMC', 'DE', 'BMY', 
                  'WBA', 'BA', 'IVZ', 'UAL', 'ABT', 'AAL', 'LMT', 'NEM', 'CAH', 'IP', 'EXC', 'CNP', 'PFE', 'EMR', 'JNJ', 'GLW', 'PPG', 'PPL', 'MMM', 'CEG', 'MRK', 'MSI', 'WBD', 'FE', 'CMS', 'CHD', 'CINF', 'WEC', 
                  'AWK', 'TXT', 'CTAS', 'PEG', 'HAL', 'XEL', 'ETR', 'AEP', 'NEE', 'EQT', 'HWM', 'NOC', 'AEE', 'CMCSA', 'CMA', 'OKE', 'CPB', 'WHR', 'F', 'DOV', 'DAL', 'ADP', 'DIS', 'TGT', 'L', 'K', 'AMP', 'HPQ', 
                  'BAX', 'DUK', 'PNW', 'APD', 'HES', 'ALK', 'DG', 'OMC', 'HRL', 'ATO', 'MAS', 'FITB', 'NUE', 'OXY', 'RF', 'MTB', 'ROL', 'SHW', 'BEN', 'AJG', 'WMB', 'EA', 'WFC', 'NI', 'APA', 'BDX', 'WY', 'IFF', 
                  'TJX', 'CMI', 'PH', 'HST', 'PKI', 'JCI', 'SJM', 'JBHT', 'HBAN', 'TDY', 'SWK', 'MCD', 'VFC', 'ES', 'TFX', 'AVY', 'MMC', 'SWKS', 'J', 'CLX', 'GPC', 'KLAC', 'CCI', 'MKC', 'JPM', 'LRCX', 'MCO', 'HUM', 
                  'UNP', 'LNC', 'BK', 'DHR', 'LLY', 'TER', 'SYY', 'RHI', 'EFX', 'BKR', 'GWW', 'LEN', 'HAS', 'IPG', 'MU', 'PHM', 'WMT', 'CAG', 'ITW', 'NKE', 'TEL', 'NDSN', 'AFL', 'NTRS', 'FRT', 'LUV', 'LNT', 'BAC', 
                  'AXP', 'CB', 'TAP', 'UDR', 'INTC', 'TRV', 'MDT', 'SNA', 'PNC', 'PCAR', 'FDX', 'ADI', 'NWL', 'SEE', 'PTC', 'AMD', 'LOW', 'BIO', 'PAYX', 'VLO', 'AON', 'TMO', 'CSX', 'GEN', 'GL', 'WST', 'PWR', 'BRO', 
                  'CI', 'NSC', 'PGR', 'PSA', 'STZ', 'D', 'KEY', 'AOS', 'COO', 'VZ', 'USB', 'HD', 'WDC', 'AIG', 'PEAK', 'MS', 'RJF', 'ECL', 'TFC', 'STT', 'SYK', 'CCL', 'SCHW', 'PXD', 'FCX', 'BR', 'DVN', 'MET', 'STX', 
                  'ACN', 'ADBE', 'IEX', 'TECH', 'V', 'VTR', 'EOG', 'CSCO', 'HOLX', 'TYL', 'PARA', 'TRMB', 'AZO', 'REGN', 'IDXX', 'AES', 'VRTX', 'ZBRA', 'BIIB', 'ODFL', 'APH', 'KIM', 'QCOM', 'GILD', 'ROP', 'SNPS', 
                  'PM', 'MHK', 'BSX', 'STE', 'DHI', 'SBUX', 'TSN', 'BLK', 'PFG', 'INTU', 'MCHP', 'CRM', 'ORLY', 'RCL', 'ALL', 'DFS', 'CRL', 'CPT', 'GRMN', 'WELL', 'BWA', 'EQR', 'UHS', 'ATVI', 'IT', 'MAR', 'NRG', 
                  'REG', 'NVR', 'INCY', 'EMN', 'SPG', 'AAP', 'MAA', 'ALB', 'MLM', 'TSCO', 'CPRT', 'AVB', 'PLD', 'ESS', 'O', 'COF', 'MCK', 'DLTR', 'ABC', 'DRI', 'WAB', 'DISH', 'RMD', 'RL', 'TPR', 'EBAY', 'ACGL', 
                  'RE', 'DVA', 'POOL', 'HSIC', 'NTAP', 'EL', 'WAT', 'HIG', 'IRM', 'FDS', 'ANSS', 'ZION', 'STLD', 'MNST', 'DGX', 'CME', 'KMX', 'TTWO', 'ARE', 'AMZN', 'BXP', 'PRU', 'YUM', 'CHRW', 'MTD', 'WTW', 'ADSK', 
                  'URI', 'VRSN', 'BBY', 'MPWR', 'SRE', 'CTSH', 'RSG', 'CSGP', 'NVDA', 'GS', 'FFIV', 'CNC', 'JNPR', 'SBAC', 'COST', 'AKAM', 'EXPE', 'UPS', 'PKG', 'EW', 'EXPD', 'ISRG', 'ILMN', 'EQIX', 'ELV', 'AVGO', 
                  'JKHY', 'ALGN', 'GPN', 'FIS', 'MDLZ', 'NFLX', 'WYNN', 'MOH', 'LKQ', 'SBNY', 'DPZ', 'EXR', 'GOOGL', 'DLR', 'MOS', 'MKTX', 'LVS', 'NDAQ', 'DXCM', 'ICE', 'LYV', 'CMG', 'TDG', 'LDOS', 'ROST', 'FSLR', 
                  'TMUS', 'ULTA', 'MSCI', 'UNH', 'VRSK', 'FTNT', 'GNRC', 'CBOE', 'TSLA']
